        ...
        <div class="col-lg-8 col-lg-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">@if (count($activities))
                                    <div class="bg-primary text-info text-center"> Customer Name: {{ $activities[0]->name }} <br>
...
<form class="form-horizontal" method="POST" action="{{ route('activity.update',  $a->id) }}">
        @csrf
        @method('PATCH')
                <div class="form-group">
                  <label for="activity_type" class="col-sm-2 control-label">Activity Type</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="activity_type" name="activity_type" placeholder="Activity Type" value="{{ $a->activity_type }}">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea name="description" class="form-control" id="description" placeholder="Activity Description">{{ $a->description }}</textarea>
                   </div>
                  </div>

                  
                        <button style="display:inline-block" type="submit" class="btn btn-primary" role="button">Update</button> 
